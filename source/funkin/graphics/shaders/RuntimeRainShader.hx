...
class RuntimeRainShader extends RuntimePostEffectShader
{
	...
	{
		var __si_uBlurredScreen = Reflect.field(this, 'uBlurredScreen');
		if (__si_uBlurredScreen != null)
			Reflect.setField(__si_uBlurredScreen, 'input', value);
	...
	{
		var __si_uMask = Reflect.field(this, 'uMask');
		if (__si_uMask != null)
			Reflect.setField(__si_uMask, 'input', value);
		return mask = value;
	}
	...
	{
		var __si_uLightMap = Reflect.field(this, 'uLightMap');
		if (__si_uLightMap != null)
			Reflect.setField(__si_uLightMap, 'input', value);
	...
	public function new()
	{
		// Load rain shader from assets if available; fall back to null (no-op shader)
		final __fragSrc = openfl.utils.Assets.exists(Paths.resolveWrite('shaders/rain.frag')) ? openfl.utils.Assets.getText(Paths.resolveWrite('shaders/rain.frag')) : null;
		super(__fragSrc);
